const config = {
  ...
  shortTitle: 'FM Chat app CSS illustration',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Chat app CSS illustration" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-chat-app-illustration.netlify.app',
